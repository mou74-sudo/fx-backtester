...
def _base_inputs() -> tuple[dict, dict, dict, dict]:
    ...
    return summary, metrics, compliance, robustness



def test_reviewer_marks_clean_run_as_provisionally_credible() -> None:
    summary, metrics, compliance, robustness = _base_inputs()
...
def test_reviewer_invalidates_compliance_failures() -> None:
    summary, metrics, compliance, robustness = _base_inputs()
...
def test_reviewer_downgrades_fragile_and_concentrated_runs() -> None:
    summary, metrics, compliance, robustness = _base_inputs()
