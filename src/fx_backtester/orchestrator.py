...
from fx_backtester.engine.pipeline import PreparedSignalData, build_rsi_signal_pipeline
...
def run_backtest_from_csv(
    *,
    ...
    repo_root: str | Path,
) -> tuple[BacktestResult, PreparedSignalData, object, Path, RobustnessLiteReport]:
    ...
    return result, prepared, quality_report, run_dir, robustness
