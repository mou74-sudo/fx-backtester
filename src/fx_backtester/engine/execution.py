"""Deterministic execution semantics for v0.4 backtests."""
...
def apply_execution_policy(
    *,
    ...
    slippage_pips = policy.slippage_pips * (2.0 if policy.slippage_model == "worse_case" else 1.0)
    slippage_delta = slippage_pips * pip_size
